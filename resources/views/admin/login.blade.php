...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/sweet-alert/sweetalert2.min.cs')}}">
    <!-- End layout styles -->
            ...
            <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                <div class="card col-lg-4 mx-auto">
                    <div class="card-body px-5 py-5">
                        <h3 class="card-title text-left mb-3">Giriş Paneli</h3>
                        <form action="{{route('login')}}" method="POST" id="loginForm">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-primary btn-block enter-btn" id="btnLogin">Giriş Yap</button>
                            </div>
                        </form>
                    </div>
                </div>
