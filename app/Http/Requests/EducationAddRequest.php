...
class EducationAddRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'university_name.max'=>'Üniversite adı alanı için en fazla 255 karakter girilmesi zorunludur',
            'university_branch.required'=>'Üniversite bölüm girilmesi zorunludur',
            'university_branch.max'=>'Üniversite bölüm alanı için en fazla 255 karakter girebilirsniz',
